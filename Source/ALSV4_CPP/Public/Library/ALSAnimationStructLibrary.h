...
struct FALSAnimCharacterInformation
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Character Information")
	float Speed = 0.0f;
...
struct FALSAnimGraphLayerBlending
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Anim Graph - Layer Blending")
	float Legs_Add = 0.0f;
