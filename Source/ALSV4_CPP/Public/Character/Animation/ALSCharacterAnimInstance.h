...
private:
	...
	void RotateToEnemyCheck(float DeltaSeconds);

	bool CanRotateToEnemy()const;
	bool IsFacingEnemy()const; 
	...
	void TurnToEnemy(AActor* FocusedEnemy);
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Read Only Data|Character Information")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Read Only Data|Anim Graph - Grounded")
	FALSAnimCharacterInformation Speed;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character Information")
	FVector MyVectorVariable;
	...
	float Legs_Add = LayerBlendingValues.Legs_Add;

	//UPROPERTY(EditAnywhere, BlueprintReadWrite)
	//EActiveState ActiveState;
	//UPROPERTY(EditAnywhere, BlueprintReadWrite)
	//EActiveState ActiveState = cpc_combat
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	UCPC_Combat* CombatComponent;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	AActor* Enemy;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float Pelvis_add = LayerBlendingValues.Pelvis_Add;
